...
1b. **Gráfico Salario CONICET Base 100**: Evolución del salario real tomando como base diciembre 2015. 
![Salario Base 100](./plots/grafico_indice_base_100.png)

2. **Gráfico de Estipendio Beca Doctoral CONICET**: Evolución del estipendio doctoral ajustado por inflación, en equivalente  a pesos del último mes.
![Estipendio Real Beca Doctoral CONICET](./plots/grafico_beca_doctoral.png)
...
![Comparativa Beca Doctoral CONICET](./plots/grafico_nominal_vs_ajustado_beca_conicet.png)
...
- Los salarios están ajustados a pesos de marzo de 2026 usando el IPC (INDEC).
